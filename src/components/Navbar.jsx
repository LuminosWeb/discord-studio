   ...
   return (
      <div className="navbar sticky w-screen flex items-center justify-between h-12 px-3 select-none z-[1000]">
         <div className="relative flex items-center gap-2">
            <div className='absolute w-full h-full cursor-pointer' onClick={() => window.electronAPI?.openExternal("https://discord.com")}/>
            <img src="/iMusic.png" alt="Avatar" className="w-8 h-8 rounded-full" />
         ...
         <div className="flex">
            ...
            <div className="flex">
               <div className="cursor-pointer" title="Ouvrir le repository Github" onClick={() => window.electronAPI?.openExternal("https://discord.com/developers/docs/intro")}>
